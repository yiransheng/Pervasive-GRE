...
var Typo = function (dictionary, affData, wordsData, settings) {
	...
	this.platform = settings.platform || "node"
	...
	if (dictionary) {
		...
		if (this.platform == "chrome") {
			if (!affData) affData = this._readFile(chrome.extension.getURL("lib/dictionaries/" + dictionary + "/" + dictionary + ".aff"));
			if (!wordsData) wordsData = this._readFile(chrome.extension.getURL("lib/dictionaries/" + dictionary + "/" + dictionary + ".dic"));
		} else {
