...
var Typo = function (dictionary, affData, wordsData, settings) {
	...
	if (dictionary) {
		...
		if (this.platform == "chrome") {
			if (!affData) affData = this._readFile(chrome.extension.getURL("dictionaries/" + dictionary + "/" + dictionary + ".aff"));
			if (!wordsData) wordsData = this._readFile(chrome.extension.getURL("dictionaries/" + dictionary + "/" + dictionary + ".dic"));
		} else {
...
Typo.prototype = {
	...
	_readFile : function (path, charset) {
        if (this.platform == "node") {
            var fs = require("fs");
            return fs.readFileSync(__dirname+"/dictionaries"+path, "utf8");
        }
									...
									if (combineRule) {
										if (combineRule.combineable && (rule.type != combineRule.type)) {
											...
											for (var iii = 0, _iiilen = otherNewWords.length; iii < _iiilen; iii++) {
												...
												dictionaryTable[otherNewWord] = word;
											}
										}
									}
								}
	...
	check : function (aWord) {
		...
		if (this.checkExact(trimmedWord)) {
			return this.checkExact(trimmedWord);
		}
		...
		if (trimmedWord.toUpperCase() === trimmedWord) {
			...
			return (this.checkExact(capitalizedWord)) 
		}
		...
		if (lowercaseWord !== trimmedWord) {
			...
			return (this.checkExact(lowercaseWord)) 
		}
	...
	checkExact : function (word) {
		...
		if (typeof ruleCodes === 'undefined') {
			...
			return (typeof ruleCodes == "string" && ruleCodes.length) ? ruleCodes : word;
		}
	},
...
},{}],3:[function(require,module,exports){// requires
...
},{}],8:[function(require,module,exports){exports.attach = function(Handlebars) {
...
},{"./visitor":11,"./printer":12,"./ast":13,"./compiler":14}],11:[function(require,module,exports){exports.attach = function(Handlebars) {
...
},{}],12:[function(require,module,exports){exports.attach = function(Handlebars) {
...
},{}],13:[function(require,module,exports){exports.attach = function(Handlebars) {
...
},{}],14:[function(require,module,exports){var compilerbase = require("./base");
...
},{"./base":15}],15:[function(require,module,exports){var handlebars = require("./parser");
...
},{"./parser":16}],16:[function(require,module,exports){// BEGIN(BROWSER)
